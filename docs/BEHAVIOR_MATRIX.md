...
| Transfer | Drag/copy between panes | Emits transfer spec to shared engine | Planned |
...
| Diagnostics | Actionable connection errors | Structured connection diagnostic report | Planned |
